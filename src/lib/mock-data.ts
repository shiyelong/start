...
export const games = [
  ...
  { id:'catchpet', name:'抓宠物', icon:'fa-paw', desc:'扔球抓可爱宠物', color:'from-rose-500 to-fuchsia-600', hot:true },
  { id:'runner', name:'像素跑酷', icon:'fa-person-running', desc:'伪3D无尽跑酷闯关', color:'from-sky-500 to-indigo-600', hot:true },
  { id:'tower', name:'塔防守卫', icon:'fa-chess-rook', desc:'建塔防御怪物入侵', color:'from-orange-500 to-red-600', hot:true },
  { id:'petbattle', name:'宠物对战', icon:'fa-dragon', desc:'收集宠物回合制战斗', color:'from-violet-500 to-purple-600', hot:true },
